  ...
  <view class="choose-file">
    ...
    <view class="choose-file__content">
      <view class="choose-file__content__item" v-for="(item, index) in files" :key="index">
        ...
        <uni-icons v-if="!readonly" type="closeempty" size="20" class="choose-file__content__item__close" color="#fff"
          @click="files.splice(index, 1)"></uni-icons>
      </view>
      <view v-if="files.length < limit&&!readonly" class="choose-file__content__item" @click="chooseFile">
